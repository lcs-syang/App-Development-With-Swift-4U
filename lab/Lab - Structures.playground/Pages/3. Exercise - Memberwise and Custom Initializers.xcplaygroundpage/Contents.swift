...
let favoriteBook = Book(title: "Hag-seed", author: "Margaret Atwood", page: 383, price: 21.00)
...
let currentHeight = Height(heightInInches: 100)
print(currentHeight.heightInCentimeters)
...
myHeight = Height(heightInCentimeters: 183)
print(myHeight.heightInCentimeters)
