...
struct User {
    ...
    static var currentUser: User = User(userName: "Selena Yang", email: "syang@lcs.on.ca", age: 15)
 ...
 */
User.logIn(user: User(userName: "Selena Yang", email: "syang@lcs.on.ca", age: 15))
