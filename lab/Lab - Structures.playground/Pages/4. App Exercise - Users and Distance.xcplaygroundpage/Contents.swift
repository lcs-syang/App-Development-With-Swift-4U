 ...
 */
var Selena = User(name: "Selena", age: 15, height: 170, weight: 45, activityLevel: 5)
print(Selena)
...
var someDistance = Distance(feet: 50)
print(someDistance)
someDistance = Distance(meters: 50)
print(someDistance)

/*:
 Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
 */
var mile = Distance(feet: 1600)
print(mile.meters)
...
var otherDistance = Distance(feet: 666)
