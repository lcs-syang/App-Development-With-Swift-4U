 ...
 */
var walkingChallenges: [String] = ["Walk 100 miles a day", "Walk 2 hours everyday"]
var runningChallenges: [String] = ["Run 500 miles a day", "Run 6 times a week"]
 ...
 */
var chllenges = [walkingChallenges, runningChallenges]
print(challenges[1].first)
...
if commitedChalleges.isEmpty {
    print("Please go and commit to a challenge.")
