 ...
 */
func pacing
    (currentIstance: Double, totalDistance:Double, currentTime:Double, goalTime: Double) {
    if currentTime > goalTime{
        print("Keep it up")
    } else {
        print("You have got to push it just a bit harder")
    }
}
pacing(currentIstance: 100, totalDistance: 200, currentTime: 200, goalTime: 200)
